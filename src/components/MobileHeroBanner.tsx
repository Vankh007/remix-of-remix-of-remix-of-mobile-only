...
const MobileHeroBanner = ({ page = 'home' }: MobileHeroBannerProps) => {
  ...
  return (
    <div 
      className="relative w-full overflow-hidden border-b border-white dark:border-transparent"
      style={{ 
    ...
    >
      {/* Background Poster with Fade Animation - extends behind status bar */}
      {posterUrl && (
        <div 
          className={cn(
            "absolute bg-cover bg-center bg-no-repeat transition-opacity duration-500",
        ...
        >
          {/* Gradient Overlay */}
          <div className="absolute inset-0 bg-gradient-to-b from-transparent via-white/30 to-white dark:from-transparent dark:via-black/50 dark:to-black" />
        </div>
      )}
