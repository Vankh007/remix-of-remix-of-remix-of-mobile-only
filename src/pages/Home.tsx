...
import MobileCastsSection from '@/components/MobileCastsSection';
...
const Home = () => {
  ...
  if (isMobile) {
    return <div className="min-h-screen scrollbar-hide">
  ...
  if (isTablet) {
    return <div className="space-y-6 pb-8 scrollbar-hide overflow-y-auto">
