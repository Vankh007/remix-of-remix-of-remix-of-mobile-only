      ...
      <LanguageProvider>
        <SiteSettingsProvider>
          <TooltipProvider>
            ...
            <Route path="/profile-settings" element={<MobileLayout><ProfileSettings /></MobileLayout>} />
            ...
            <Route path="/history" element={<MobileLayout><History /></MobileLayout>} />
            <Route path="/liked" element={<MobileLayout><Liked /></MobileLayout>} />
            <Route path="/my-list" element={<MobileLayout><MyList /></MobileLayout>} />
            <Route path="/my-reports" element={<MobileLayout><MyReports /></MobileLayout>} />
            <Route path="/subscriptions" element={<MobileLayout><Subscriptions /></MobileLayout>} />
            <Route path="/shop" element={<MobileLayout><Shop /></MobileLayout>} />
            <Route path="/premium" element={<MobileLayout><PremiumMember /></MobileLayout>} />
            <Route path="/collections" element={<MobileLayout><Collections /></MobileLayout>} />
            <Route path="/collections/:slug" element={<MobileLayout><CollectionDetail /></MobileLayout>} />
            <Route path="/series" element={<MobileLayout><Series /></MobileLayout>} />
            <Route path="/series/:id" element={<SeriesDetail />} />
            <Route path="/movies" element={<MobileLayout><Movies /></MobileLayout>} />
            <Route path="/short" element={<MobileLayout><Short /></MobileLayout>} />
            <Route path="/viral" element={<MobileLayout><Viral /></MobileLayout>} />
            <Route path="/watch/:id" element={<MobileLayout><Watch /></MobileLayout>} />
<Route path="/watch/:type/:id" element={<MobileWatch />} />
<Route path="/watch/:type/:id/:season/:episode" element={<MobileWatch />} />
<Route path="/embed/series/:id/:season/:episode" element={<EmbedSeries />} />
            <Route path="/embed/movies/:id" element={<EmbedMovies />} />
            <Route path="/search" element={<MobileLayout><Search /></MobileLayout>} />
            <Route path="/privacy-policy" element={<MobileLayout><PrivacyPolicy /></MobileLayout>} />
            <Route path="/terms-of-service" element={<MobileLayout><TermsOfService /></MobileLayout>} />
            <Route path="/about" element={<MobileLayout><AboutUs /></MobileLayout>} />
            <Route path="/contact" element={<MobileLayout><Contact /></MobileLayout>} />
            <Route path="/faq" element={<MobileLayout><FAQ /></MobileLayout>} />
            <Route path="/how-it-works" element={<MobileLayout><HowItWorks /></MobileLayout>} />
            <Route path="/features" element={<MobileLayout><Features /></MobileLayout>} />
            <Route path="/blog" element={<MobileLayout><Blog /></MobileLayout>} />
            <Route path="/dmca" element={<MobileLayout><DMCA /></MobileLayout>} />
